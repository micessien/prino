        ...
        <form action="/projects/create4" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <textarea name="stadedevelopement" placeholder="Descriptif de l’évolution du projet (500 signes maximum espaces compris)" value="{{ $user->projects->stadedevelopement }}" class="form-control" id="stadedevelopement" rows="3"></textarea>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <textarea name="besoinfinancement" placeholder="Descriptif du financement du projet (1000 signes maximum espaces compris)" value="{{ $user->projects->besoinfinancement }}" class="form-control" id="besoinfinancement" rows="3"></textarea>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <textarea name="repartitioncapitale" placeholder="Descriptif de la structure du Capital de l’entité (200 signes maximum espaces compris)" value="{{ $user->projects->repartitioncapitale }}" class="form-control" id="repartitioncapitale" rows="3"></textarea>
                </div>
            </div>
