    ...
    <div class="panel-body">
        ...
        <form action="/projects/create" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea name="descriptifentreprise" placeholder="Descriptif de l'entreprise (1000 signes maximum espaces compris)" value="" class="form-control{{ $errors->has('descriptifentreprise') ? ' is-invalid' : '' }}" id="descriptifentreprise" rows="3">{{ old('descriptifentreprise',($user->projects!=null ? $user->projects->descriptifentreprise:'')) }}</textarea>
