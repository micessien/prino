        ...
        <form action="/projects/create" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input required type="text" name="entite" value="{{ old('entite',($user->projects!=null ? $user->projects->entite:'')) }}" class="form-control" id="entite" placeholder="entite">
                </div>
                <div class="form-group col-md-6">
                    <label for="categorie"><span style="color:#ff0000">*</span> Catégorie</label>
                    <input required type="text" name="categorie" value="{{ old('categorie',($user->projects!=null ? $user->projects->categorie:'')) }}" class="form-control" id="categorie" placeholder="categorie">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input required type="text" name="adresse" value="{{ old('adresse',($user->projects!=null ? $user->projects->adresse:'')) }}" class="form-control" id="adresse" placeholder="1234 Main St">
                </div>
                <div class="form-group col-md-6">
