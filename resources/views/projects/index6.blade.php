...
<div class="panel panel-default">
                ...
                <form action="/projects/create4" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                                ...
                                {{-- <div class="form-group col-md-6">
                                        ...
                                        <input name="powerpoint" value="{{ $user->projects->powerpoint }}" type="text" class="form-control-file" id="exampleFormControlFile1">
                        </div>
        </div>
        ...
        <div class="form-row">
                <div class="form-group col-md-6">
                        ...
                        <input name="declarationfiscale" value="{{ $user->projects->declarationfiscale }}" type="text" class="form-control-file" id="exampleFormControlFile1">
                </div>
                <div class="form-group col-md-6">
                        <label for="exampleFormControlFile1">Business Plan à 3 ans (.xlsx)</label>
                        <input name="businessplan" value="{{ $user->projects->businessplan }}" type="text" class="form-control-file" id="exampleFormControlFile1">
                </div>
        </div>
